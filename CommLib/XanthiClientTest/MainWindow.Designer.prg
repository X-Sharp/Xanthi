...
BEGIN NAMESPACE XanthiClientTest
    ...
    PUBLIC PARTIAL CLASS MainWindow
        ...
        PRIVATE startServer AS System.Windows.Forms.Button
   ...
   RETURN
        ...
        PRIVATE METHOD InitializeComponent() AS VOID STRICT
            ...
            SELF:startServer := System.Windows.Forms.Button{}
            ...
            // groupBox1
            // 
            SELF:groupBox1:Controls:Add(SELF:startServer)
            ...
            // startServer
            // 
            SELF:startServer:Location := System.Drawing.Point{495, 21}
            SELF:startServer:Name := "startServer"
            SELF:startServer:Size := System.Drawing.Size{75, 23}
            SELF:startServer:TabIndex := 5
            SELF:startServer:Text := "Start"
            SELF:startServer:UseVisualStyleBackColor := true
            SELF:startServer:Click += System.EventHandler{ SELF, @startServer_Click() }
            // 
            // portNumber
            // 
