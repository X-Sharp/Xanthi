...
BEGIN NAMESPACE XanthiClientTest
   ...
   RETURN
        ...
        PRIVATE METHOD InitializeComponent() AS VOID STRICT
            ...
            // buttonSend
            // 
            SELF:buttonSend:Location := System.Drawing.Point{230, 93}
            ...
            SELF:groupBox2:Size := System.Drawing.Size{618, 180}
            ...
            SELF:groupBox5:Location := System.Drawing.Point{473, 28}
            SELF:groupBox5:Name := "groupBox5"
            SELF:groupBox5:Size := System.Drawing.Size{120, 131}
            ...
            SELF:buttonMultiSend:TabIndex := 14
            ...
            SELF:groupBox4:Location := System.Drawing.Point{344, 28}
            SELF:groupBox4:Name := "groupBox4"
            SELF:groupBox4:Size := System.Drawing.Size{123, 131}
            ...
            // tbCommandReply
            // 
            SELF:tbCommandReply:Location := System.Drawing.Point{6, 61}
            SELF:tbCommandReply:Name := "tbCommandReply"
            SELF:tbCommandReply:ReadOnly := true
            SELF:tbCommandReply:Size := System.Drawing.Size{100, 22}
            SELF:tbCommandReply:TabIndex := 12
            // 
            // tbCodeReply
            // 
            SELF:tbCodeReply:Location := System.Drawing.Point{6, 32}
            SELF:tbCodeReply:Name := "tbCodeReply"
            SELF:tbCodeReply:ReadOnly := true
            SELF:tbCodeReply:Size := System.Drawing.Size{100, 22}
            SELF:tbCodeReply:TabIndex := 11
            // 
            // tbPayloadReply
            // 
            SELF:tbPayloadReply:Location := System.Drawing.Point{6, 91}
            SELF:tbPayloadReply:Name := "tbPayloadReply"
            SELF:tbPayloadReply:ReadOnly := true
            SELF:tbPayloadReply:Size := System.Drawing.Size{100, 22}
            SELF:tbPayloadReply:TabIndex := 13
            // 
            // groupBox3
            // 
            ...
            SELF:groupBox3:Controls:Add(SELF:tbCode)
            SELF:groupBox3:Controls:Add(SELF:tbCommand)
            SELF:groupBox3:Location := System.Drawing.Point{16, 28}
            SELF:groupBox3:Name := "groupBox3"
            SELF:groupBox3:Size := System.Drawing.Size{317, 131}
            ...
            SELF:label3:Location := System.Drawing.Point{16, 37}
            ...
            SELF:label5:Location := System.Drawing.Point{16, 96}
            ...
            // tbPayLoad
            // 
            SELF:tbPayLoad:Location := System.Drawing.Point{99, 93}
            ...
            // tbCode
            // 
            SELF:tbCode:Location := System.Drawing.Point{99, 34}
            ...
            // tbCommand
            // 
            SELF:tbCommand:Location := System.Drawing.Point{99, 63}
